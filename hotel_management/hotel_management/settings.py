...
SECRET_KEY = 'django-insecure-uhlo57r8@t@&!)ucczshh4r1q)z)$81fkl1+b@xn4*x-^@)4+$'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql', # 不用改
        'NAME': 'hotel_manage', # 数据库名字
        'USER': 'root',
        'PASSWORD': 'root',
...
AUTHENTICATION_BACKENDS = [
    'booking.backends.CustomUserBackend',  # 'your_app' 替换为您的应用名称
